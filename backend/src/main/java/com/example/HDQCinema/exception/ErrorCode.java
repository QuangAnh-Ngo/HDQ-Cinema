...
public enum ErrorCode {
    ...
    SHOWTIME_NOT_FOUND(7001, "Showtime not found", HttpStatus.NOT_FOUND),
    SHOWTIME_EXISTED(7002, "Showtime already exists for this room and time", HttpStatus.BAD_REQUEST),
